...
class ModelTests(TestCase):
    ...
    def setUp(self):
        ...
        self.kiarash_user = User.objects.create_user(username='kiarash', email='kiarash@test.tst', password='kiarashpass')
        ...
        self.ali_auction = Auction.objects.create(owner=self.ali, deadline=timezone.now() + datetime.timedelta(days=3), base_price=100)
        self.mahdi_auction = Auction.objects.create(owner=self.mahdi, deadline=timezone.now() - datetime.timedelta(days=3), base_price=1000)
